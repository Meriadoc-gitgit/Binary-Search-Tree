...
{ // tao ra them 1 mot va cho vao day liste
  Lm_mot *plm = lm;
  ...
  if (strcmp(mot, lm->mot) <= 0) // neu mot ngan hon hoac dai bang lm->mot
  {
    npm->suiv = lm; // moi mot se o 1 khuon, nen khong qua phuc tap
    return npm;
  }
